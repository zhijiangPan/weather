...
namespace ZhijiangPan\Weather\Tests;
...
use ZhijiangPan\Weather\HttpException;
use ZhijiangPan\Weather\InvalidArgumentException;
...
class WeatherTest extends TestCase
{
    ...
    public function testGetWeather()
    {
        ...
        // 降 `getHttpClient` 方法替换为上面创建的 http client 为返回值的模拟方法
